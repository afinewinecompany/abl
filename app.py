...
try:
    logger.debug("Applying custom styling...")
    st.markdown("""
    <style>
    ...
    logger.debug("Custom styling applied successfully")
except Exception as e:
...
def main():
    try:
        ...
        try:
            ...
            logger.error(traceback.format_exc())
            st.error("An error occurred while loading data. Please try refreshing.")
